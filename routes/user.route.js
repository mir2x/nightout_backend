...
router.patch("/block-account/:id", checkUser, userController.blockAccountByAdmin);

router.patch("/active-account/:id", checkUser, userController.activeAccountByAdmin);
