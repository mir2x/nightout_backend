...
exports.categoryUpdate = catchAsync(async (req, res, next) => {
  ...
  if (isExist.role == "ADMIN" || isExist.role == "SUPER ADMIN") {
    ...
    if (existingDocument) {
      ...
      updateData.categoryImage = categoryImageName
        ? categoryImageName
      ...
      if (existingDocument) {
        ...
        updateData.categoryImage = categoryImageName
          ? categoryImageName
          : existingDocument.categoryImage;
        updateData.someExtraField = updateData.someExtraField
          ? JSON.parse(updateData.someExtraField)
          : someExtraField;
